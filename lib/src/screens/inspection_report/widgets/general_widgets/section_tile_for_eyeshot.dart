    ...
    return Row(
      ...
      children: [
        ...
        Row(
          ...
          children: [
            SvgPicture.asset(
              "lib/src/assets/svg/comments.svg",
              width: 12,
              height: 12,
            ),
            ...
            const SizedBox(width: 7.17),
            SvgPicture.asset(
              "lib/src/assets/svg/deficiency.svg",
              width: 12,
              height: 12,
            ),
            const SizedBox(width: 7.17),
            ...
            hasSubsections
                ? SvgPicture.asset(
                    "lib/src/assets/svg/${isExpanded[sectionIndex] ? "expand_withoutbackground" : "unexpand_withoutbackground"}.svg",
                  )
                : const SizedBox()
          ],
        )
