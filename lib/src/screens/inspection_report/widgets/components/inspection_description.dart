...
class InspectionDescription extends StatelessWidget {
  ...
  final User user;
  const InspectionDescription({Key? key, required this.inspection, required this.user, required this.selectedTemplate})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    if(inspection.client!.firstname.isNotEmpty || inspection.client!.lastname.isNotEmpty){
      contactDetail = true;
    }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // ),
              const SizedBox(height: 10),
              userDetail ? SubHeadingOfInspectionDescritpion(
              ...
              const SizedBox(height: 10),
              contactDetail ? SubHeadingOfInspectionDescritpion(
                primaryText: "Prepared for:",
                secondryText:
              ...
              Text("At the time of inspection the component is functional without observed signs of a substantial defect.",
                  style: secondryHeadingTextStyle.copyWith(
                    color: ProjectColors.pickledBluewood,
                  )),
              const SizedBox(height: 10),
              ...
              const SizedBox(height: 5),
              Text("At the time of inspection the component is functioning but is estimated to be nearing end of useful life. Operational maintenance recommended. Replacement anticipated.",
                  style: secondryHeadingTextStyle.copyWith(
                    color: ProjectColors.pickledBluewood,
                  )),
              const SizedBox(height: 10),
              ...
              const SizedBox(height: 5),
              Text("At the time of inspection the component does not function as intended or presents a Safety Hazard. Repair or replacement is recommended.",
                  style: secondryHeadingTextStyle.copyWith(
                    color: ProjectColors.pickledBluewood,
                  )),
              const SizedBox(height: 10),
              ...
              const SizedBox(height: 5),
              Text("The component requires further technical or invasive evaluation by qualified professional tradesman or service technician to determine the nature of any potential defect, the corrective action and any  associated cost.",
                  style: secondryHeadingTextStyle.copyWith(
                    color: ProjectColors.pickledBluewood,
                  )),
              const SizedBox(height: 10),
